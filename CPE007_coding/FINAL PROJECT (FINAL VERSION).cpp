...
// This will be where the user will be stored
...
// Loging in for users that have account
bool loginUser(string &currentUser) {
    string uname, pword;
    cout << "Username: ";
    cin >> uname;
...
void viewReports() {
    ...
    for (int i = 0; i < assetCount; i++)
        cout << assets[i] << " [" << assetTags[i] << "]: $" << assetValues[i] << "\n";

    cout << "\nBudgets:\n";
    for (int i = 0; i < budgetCount; i++)
        cout << budgets[i] << " [" << budgetTags[i] << "]: $" << budgetAmounts[i] << "\n";

    cout << "\nExpenses:\n";
    for (int i = 0; i < expenseCount; i++)
        cout << expenses[i] << " [" << expenseTags[i] << "]: $" << expenseAmounts[i] << "\n";

    cout << "\nLoans:\n";
    for (int i = 0; i < loanCount; i++)
        cout << borrowers[i] << " [" << loanTags[i] << "]: $" << loanAmounts[i] << "\n";
}
